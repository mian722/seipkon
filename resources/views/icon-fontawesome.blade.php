               ...
               <div class="container-fluid">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="page-box">
                           <div class="font-box">
                              <h3>41 New Icons in 4.7</h3>
                              <div class="row">
                                 <div class="col-md-3 col-sm-4">
                                    <div class="single-font-item">
                        ...
                        <div class="page-box">
                           <div class="font-box">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-3 col-sm-4">
                                    <div class="single-font-item">
                                       <i class="fa fa-repeat-left" aria-hidden="true"></i> 
                                       repeat-left<span class="text-muted">(alias)</span>
                                    </div>
                                 </div>
                                 <!-- End Col -->
                                 <div class="col-md-3 col-sm-4">
                                    <div class="single-font-item">
                                       <i class="fa fa-repeat-right" aria-hidden="true"></i> 
                                       repeat-right<span class="text-muted">(alias)</span>
                                    </div>
                                 </div>
                                 <!-- End Col -->
                                 <div class="col-md-3 col-sm-4">
